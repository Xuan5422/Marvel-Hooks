...
const Spiner = () => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{margin: '0 auto', background: 'rgb(255, 255, 255)', display: 'block', shapeRendering: 'auto'}} width="381px" height="381px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                ...
                <g transform="scale(0.4)">
                    <g transform="translate(-50 -50)">
                        <g>
                            ...
                            <path fill-opacity="0.7" fill="#e15b64" d="M50 50L50 0A50 50 0 0 1 100 50Z"></path>
                        </g>
                        <g>
                            ...
                            <path fill-opacity="0.7" fill="#f47e60" d="M50 50L50 0A50 50 0 0 1 100 50Z" transform="rotate(90 50 50)"></path>
                        </g>
                        <g>
                            ...
                            <path fill-opacity="0.7" fill="#f8b26a" d="M50 50L50 0A50 50 0 0 1 100 50Z" transform="rotate(180 50 50)"></path>
                        </g>
                        <g>
                            ...
                            <path fill-opacity="0.7" fill="#abbd81" d="M50 50L50 0A50 50 0 0 1 100 50Z" transform="rotate(270 50 50)"></path>
                        </g>
                    </g>
                </g>
            </g>
